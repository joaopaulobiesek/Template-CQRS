...
using Template.Application.Domains.InternalServices.Clients.Commands.CreateClient;
using Template.Application.Domains.InternalServices.Clients.Commands.DeactivateClient;
using Template.Application.Domains.InternalServices.Clients.Commands.UpdateClient;
using Template.Application.Domains.InternalServices.Clients.Queries.GetAll;
using Template.Application.ViewModels.Clients;
using Template.Application.ViewModels.Users;

namespace Template.Api.Controllers.InternalServices.Tenant;
...
public class ClientController : BaseController
{
    ...
    /// <returns></returns>
    [HttpPost]
    [ProducesResponseType(StatusCodes.Status200OK, Type = typeof(SucessoResponse<ClientVM>))]
    [ProducesResponseType(StatusCodes.Status400BadRequest, Type = typeof(ErroResponse<ClientVM>))]
